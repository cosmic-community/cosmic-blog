        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              A modern blog platform powered by Cosmic CMS. Discover amazing content 
              from our talented writers covering technology, travel, and lifestyle.
            </p>
          </div>
